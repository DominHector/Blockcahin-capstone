...
contract Ownable {
    ...
    modifier requireOnlyOwner() {
        require(_owner == msg.sender, "Contract is currently not operational");
        _;
    }
...
//  2) create a public setter using the inherited onlyOwner modifier
    function setPaused(bool paused) public requireOnlyOwner {
        _paused = paused;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "address to not be the owner of the tokenId");

        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(_isApprovedOrOwner(msg.sender, tokenId), "msg sender not be the owner contract");
...
contract ERC721Mintable is ERC721Metadata('PenelaToken', 'PNL', 'https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/')
{
    constructor() public { }
