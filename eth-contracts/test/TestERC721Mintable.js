var ERC721MintableComplete = artifacts.require('PenelaToken');
...
contract('TestERC721Mintable', accounts => {
    ...
    describe('match erc721 spec', function () {
        ...
        it('should transfer token from one owner to another', async function () {
            ...
            var result = await this.contract.approve(accounts[2], tokenId, {from: accounts[1]});

            var result = await this.contract.transferFrom(accounts[1], accounts[2], tokenId, {from: accounts[1]});
